...
class MyWindow:
    def __init__(self, win):
        ...
        rad50.place(x=165, y=-130+270)
        rad51.place(x=195, y=-130+270)
        rad52.place(x=225, y=-130+270)
        rad53.place(x=255, y=-130+270)
        rad54.place(x=285, y=-130+270)
        rad55.place(x=315, y=-130+270)
        ...
        rad7.place(x=165, y=-130+320)
        rad8.place(x=215, y=-130+320)
        rad81.place(x=265, y=-130+320)
        rad9 = Radiobutton(window,text='Yes', variable=self.num5, value=1)
        rad10 = Radiobutton(window,text='No', variable=self.num5, value=0)
        rad9.place(x=165, y=-130+370)
        rad10.place(x=215, y=-130+370)
        rad11 = Radiobutton(window,text='Yes', variable=self.num6, value=1)
        rad12 = Radiobutton(window,text='No', variable=self.num6, value=0)
        rad11.place(x=165, y=-130+420)
        rad12.place(x=215, y=-130+420)
        self.resr=Entry()
        self.lbl0.place(x=15,y=5)
        self.lbl1.place(x=15, y=-130+180)
        self.lbl2.place(x=15, y=-130+220)
        self.lbl3.place(x=15, y=-130+270)
        self.lbl4.place(x=15, y=-130+320)
        self.lbl5.place(x=15, y=-130+370)
        self.lbl6.place(x=15, y=-130+420)
        self.b1=Button(win, text='Run model', command=self.add, font='Helvetica 14 bold')
        self.b1.place(x=15, y=-130+470)
        self.resl.place(x=15, y=-130+530)
        self.resr.place(x=150, y=-130+530)
    def add(self):
        ...
        # img4.image = render4
        # img4.place(x=900, y=-130+510)

        self.SPE.place(x=15, y=-130+560)
        self.REC.place(x=15, y=-130+590)
        self.PRE.place(x=15, y=-130+620)
        self.NPV.place(x=15, y=-130+650)
        ...
        self.RSPE.place(x=150, y=-130+560)
        self.RREC.place(x=150, y=-130+590)
        self.RPRE.place(x=150, y=-130+620)
        self.RNPV.place(x=150, y=-130+650)

        self.RSPE.insert(END, str('%.3f' %SPE))
        self.RREC.insert(END, str('%.3f' %REC))
        self.RPRE.insert(END, str('%.3f' %PREC))
        self.RNPV.insert(END, str('%.3f' %NPV))

        self.resr.insert(END, str('%.3f' %result))
window=Tk()
mywin=MyWindow(window)
window.title('Stent Restenosis calculator')
window.geometry("820x690+10+10")

load1 = Image.open("180517 logo IBSAL_bueno.jfif")
load1 = load1.resize((160,70), Image.ANTIALIAS)
render1 = ImageTk.PhotoImage(load1)
img1 = Label(window, image=render1)
img1.image = render1
img1.place(x=10, y= 690 - 90)

load1 = Image.open("ciber.png")
load1 = load1.resize((180,70), Image.ANTIALIAS)
render2 = ImageTk.PhotoImage(load1)
img2 = Label(window, image=render2)
img2.image = render1
img2.place(x=170, y= 690 - 90)
